export function FacebookIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
	...
	c-1.567-1.757-3.811-2.763-6.164-2.763h-74.316V118.88c0-16.073,8.654-24.224,25.726-24.224c2.433,0,48.59,0,48.59,0
...
export function MapPinIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M190.716,37.192c0-5.5-4.407-9.092-9.794-7.981l-64.844,13.365c-5.387,1.11-9.794,6.519-9.794,12.019v205.723
       c0,5.5,4.402,9.066,9.782,7.925l64.867-13.76c5.38-1.142,9.782-6.575,9.782-12.075V37.192z"
      />
      <path
        d="M7.766,250.385l74.879,17.639c5.354,1.261,9.733-2.207,9.733-7.707V54.594c0-5.5-4.386-11.009-9.745-12.242L12.101,26.128
       c-2.939-0.659-6.024,0.056-8.378,1.941C1.37,29.955,0,32.807,0,35.822v204.87C0,245.343,3.227,249.371,7.766,250.385z"
      />
      <path
        d="M284.899,270.873c0.719,0.161,1.445,0.239,2.168,0.239c2.235,0,4.432-0.755,6.21-2.18c2.353-1.886,3.723-4.738,3.723-7.753
