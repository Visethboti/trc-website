export const ui: Record<string, Record<string, string>> = {
  en: {
    ...
    "footer.address":
      "Street 102, Sangkat Wat Phnom, Khan Daun Penh, Phnom Penh",
    "footer.quickLink": "Quick Links",
    "footer.copyright":
      "All right reserved by Telecommunication Regulator of Cambodia - T.R.C",
    ...
    "nav.services.public": "Public",
    "nav.services.domainKH": "Domain .KH",
    "nav.services.internetCafe": "Internet Cafe",
    "nav.services.telecomEquipmentShop": "Telecom Equipment Shop",
    "nav.services.operator": "Operator",
    ...
    "nav.services.towerConstructionPermit": "Tower Construction Permit",
    ...
    "nav.resources.typeApproval": "Type Approval",
    ...
    "emergencyNumber.ministryofInterior": "Ministry of Interior",
    "emergencyNumber.ministryofHealth": "Ministry of Health",
    "emergencyNumber.ministryofAgricutureForestryandFisheries":
    ...
    "about.mission.list2":
      "Enforcing policies and regulations related to the telecommunications sector and information communication technology, as devised by the Ministry of Post and Telecommunications.",
    "about.mission.list3":
  ...
  km: {
    ...
    "footer.followUs": "បណ្ដាញសង្គម",
    "nav.lawsRegulations": "ច្បាប់់និងបទប្បញ្ញត្តិ",
    "nav.lawsRegulations.laws": "ច្បាប់់",
    "nav.lawsRegulations.royalDecrees": "ព្រះរាជក្រឹត្យ",
    "nav.lawsRegulations.subDecrees": "អនុក្រឹត្យ",
    "nav.lawsRegulations.circulations": "សារាចរ",
    "nav.lawsRegulations.prakas": "ប្រកាស",
    "nav.lawsRegulations.decisions": "សេចក្ដីសម្រេច",
    "nav.lawsRegulations.guidelines": "សេចក្ដីណែនាំ",
    "nav.services": "សេវាកម្ម",
    "nav.services.public": "សាធារណៈជន",
    ...
    "nav.services.qualifiedAgentCertification":
    ...
    "nav.media": "ព័ត៌មាន",
    "nav.media.newsReleases": "ព័ត៌មាន",
    "nav.media.activities": "សកម្មភាព",
    "nav.media.events": "ព្រឹត្តិការណ៍",
    "nav.resources": "ឯកសារ",
    "nav.resources.publications": "បណ្ដុំឯកសារ",
    "nav.resources.telecomStatistics": "ស្ថិតិទូរគមនាគមន៍",
    "nav.resources.activeOperators": "ប្រតិបត្តិករ",
    ...
    "nav.about.aboutTRC": "អំពីយើង",
    "nav.about.trcLeader": "ថ្នាក់ដឹកនាំ",
    "nav.about.trcStructure": "រចនាសម្ព័ន្ធ",
    "nav.contact": "ទំនាក់ទំនង",
    "home.serviceWeOffer": "សេវាកម្មដែលយើងផ្តល់ជូន",
    "home.serviceWeOffer.forPublic": "សាធារណៈជន",
    "home.serviceWeOffer.forOperator": "ប្រតិបត្តិករ",
    "home.serviceWeOffer.forPublic.domainKH": "ឈ្មោះដែនជាតិ",
    "home.serviceWeOffer.forPublic.internetCafePermit": "សាលបម្រើសេវាអ៊ីនធឺណិត",
    "home.serviceWeOffer.forPublic.telecomEquipmentShop":
      "ហាងបើកលក់និងជួសជុលគ្រឿងសម្ភារៈបរិក្ខារទូរគមនាគមន៍",
    "home.serviceWeOffer.forOperator.internetServiceProviderLicense":
      "អាជ្ញាប័ណ្ណអ្នកផ្តល់សេវាអ៊ីនធឺណិត",
    "home.serviceWeOffer.forOperator.spectrumLicense":
      "អាជ្ញាបណ្ណវិសាលគមន៍ហ្រ្វេកង់ស៍វិទ្យុ",
    "home.serviceWeOffer.forOperator.towerConstructionPermit":
      "លិខិតអនុញ្ញាតសាងសង់បង្គោលអង់តែន",
    "home.serviceWeOffer.forOperator.fiberCableConstructionPermit":
      "លិខិតអនុញ្ញាតសាងសង់ខ្សែកាប្លិ៍អុបទិក",
    "home.serviceWeOffer.forOperator.telecomNumberingPermit":
      "លិខិតអនុញ្ញាតលេខទូរគមនាគមន៍",
    "home.serviceWeOffer.forOperator.equipmentImportationDistributionPermit":
      "លិខិតអនុញ្ញាតនាំចូលនិងចែកចាយគ្រឿងសម្ភារបរិក្ខារ",
    "home.serviceWeOffer.forOperator. frequencyInterferenceComplaint":
      "បណ្តឹងលើការឆ្លងរំខានហ្វ្រេកង់ស៍",
    ...
    "home.speedtest.description":
      "វាស់ស្ទង់ល្បឿនអ៊ីនធឺណិតចល័តគ្រប់ទីកន្លែងនិងគ្រប់ពេលវេលាជាមួយនឹងលទ្ធផលត្រឹមត្រូវនិងងាយស្រួលប្រើ។ សម្រាប់ព័ត៌មានបន្ថែម សូមចូលទៅកាន់ ",
    "home.unitLink.ministryAutonomousUnits": "ក្រសួង និងអង្គភាពស្វយ័ត",
    "emergencyNumber.ministryofInterior": "ក្រសួងមហាផ្ទៃ",
    "emergencyNumber.ministryofHealth": "ក្រសួងសុខាភិបាល",
    "emergencyNumber.ministryofAgricutureForestryandFisheries":
